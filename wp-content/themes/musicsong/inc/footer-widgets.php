...
class Musicsong_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'musicsong';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'musicsong' ), $i ),
...
// Initialize.
$musicsong_footer_widgets = new Musicsong_Footer_Widgets();
